...
class Windcord(commands.Cog):
    ...
    async def leaderboard(self, ctx):
        """Wind Leaderboard"""
        windleader = ("https://docs.google.com/spreadsheets/d/1nNdo4sA790aLqFIXqzCeT89ry8dbqPUYA2VmOMxnnF8/edit?usp=sharing","https://docs.google.com/spreadsheets/d/1nNdo4sA790aLqFIXqzCeT89ry8dbqPUYA2VmOMxnnF8/edit?usp=sharing")
        await ctx.send(random.choice(windleader))
    ...
    async def payout(self, ctx):
        ...
        await ctx.send("https://cdn.discordapp.com/attachments/471520212886487040/689170873105645591/payout.png")
